	...
	<div class="navbar h-14 px-4 sm:px-8 bg-base-100 border-b border-base-200 shadow-sm overflow-x-hidden">
		<div class="flex-1">
			<a href="/" class="flex items-center pl-2">
				...
				<span class="ml-3 text-lg font-semibold tracking-wide text-base-content hidden sm:inline">Mail Hook</span>
			</a>
		</div>
		<div class="flex items-center gap-2 sm:gap-6">
			...
			{:else}
				...
				>
					...
					<span class="hidden sm:inline">Mailboxes</span>
				</a>
				<div class="dropdown dropdown-end">
					<div class="tooltip tooltip-bottom" data-tip="Account Settings">
						<button
							class="avatar flex items-center gap-2 cursor-pointer group hover:opacity-90 transition-opacity"
						...
						>
							...
							<span class="text-base-content/70 group-hover:text-base-content transition-colors hidden sm:inline">
								{$auth.username}
							</span>
						</button>
					</div>
